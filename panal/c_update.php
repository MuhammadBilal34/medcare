 ...
 <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Edited Basic Profile </h3>
                                    <?PHP
                                      include("config.php");
					                            $ab=$_GET['az'];
					                            $sql="select * from city where id='$ab'";
        ...
        $mess=mysqli_error();
                                  ...
                                  <form method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="e_n"  value=" <?php echo $result['city_name'] ?>" />
                                      </div>
                                      <div class="form-group">
                                        <label>Postal Code</label>
                                        <input class="form-control" type="text" name="e_u"  value=" <?php echo $result['postal_code'] ?>" />
                                      </div>
      ...
      <?php
        ...
        if(isset($_POST['submit'])){
	      ...
	      $sql="update city set city_name='$b',postal_code='$c' where id='$a'";
