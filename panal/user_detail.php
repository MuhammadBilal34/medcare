                    ...
                    <div class="chat-panel panel panel-default chat-boder chat-panel-head" >
                        ...
                        <div class="panel-body">
                          ...
                          <?php
                           ...
                           <td><a href="e_table.php"><img src="<?php echo $result['img']; ?>"  style="height:100px; width:100px;"></a></td>
                            <td><a  href="d_delete.php?abc=<?php echo $result['Id']?>" style="text-decoration:none; color:#000;">
                                            ...
                                            <td><a href="dr_update.php?az=<?php echo $result['Id']?>" style="text-decoration:none; color:#000;">
