...
?>  
 ...
 <li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?PHP
                                      include("config.php");
					                            $ab=$_GET['az'];
					                            $sql="select * from reg where Id='$ab'";
      ...
      else
      {
        $mess=mysqli_error();
                                  ...
                                  <form method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        <label>Doctor avability</label>
                                        <input class="form-control" type="text" name="e_u"  value=" <?php echo $result['username'] ?>" />
                                      </div>
                                      <div class="form-group">
                                            <label>Doctor education</label>
                                            <input class="form-control" type="text" name="e_p"  value="<?php echo $result['email'] ?>"/>
                                      </div>
                                      <div class="form-group">
                                            <label>Doctor experience</label>
                                            <input class="form-control" type="text" name="e_rp"  value="<?php echo $result['password'] ?> "/>
                                      </div>
                                      <div class="form-group">
                                            <label>Doctor location</label>
                                            <input  class="form-control" type="text" name="e_i" value="<?php echo $result['r_password'] ?>" /> 
                                      <div class="form-group">
                                      <label> 
                                          <?php 
      ...
      <?php
        ...
        $d=$_POST['e_rp'];
        $e=$_POST['e_i'];
	      $sql="update reg set name='$a',username='$b',email='$c' ,password='$d' ,r_password='$e' where Id='$ab'";
