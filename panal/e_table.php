                        ...
                        <div class="panel-body">
                          ...
                          <?php
                                      ...
                                      <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $result['av'] ?></td>
                                            <td><?php echo $result['ed'] ?></td>
                                            <td><?php echo $result['ex'] ?></td>
                                            <td><?php echo $result['location'] ?></td>
                                            <td><img src="upload/<?php echo $result['img']; ?>"  style="height:100px; width:100px;"></td>
                                            <td><a  href="e_delete.php?abc=<?php echo $result['id']?>" style="text-decoration:none; color:#000;">
                                            <button  class="btn btn-success" >Delete</a></td>
                                            <td><a href="e_update.php?az=<?php echo $result['id']?>" style="text-decoration:none; color:#000;">
      ...
      <input type="submit" name="search" value="SEARCH" class="btn btn-primary"><br><br>
           <?php
              include("config.php");
	            ...
	            //echo"$n";
	            $q ="SELECT * FROM reg WHERE name like '%$n%'";
