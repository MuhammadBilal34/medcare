...
?>  
 ...
 <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Edited Patient Details </h3>
                                    <?PHP
                                      include("config.php");
                                                $ab=$_GET['az'];
                                                $sql="select * from p_login where id='$ab'";
        ...
        $mess=mysqli_error();
                                  ...
                                  <form method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="d_user"  value="<?php echo $result['d_user'] ?>"/>
                                      </div>
                                      ...
                                      <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="pass"  value="<?php echo $result['password'] ?> "/>
                                      </div>                                     <div class="form-group">
                                            <label>Patient Re-type Password </label>
                                            <input class="form-control" type="text" name="r_password"  value="<?php echo $result['r_password'] ?> "/>
                                      </div>
                                      <div class="form-group">
                                      <label> 
                                          <?php 
  ...
  <?php
        ...
        $sql="update p_login set name='$name',d_user='$d_user',email='$email' ,password='$password' , r_password='r_password'where id='$ab'";
