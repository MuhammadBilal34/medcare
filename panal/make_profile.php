    ...
    <div id="wrapper">
     ...
     <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div  class="navbar-header">
                ...
                <a class="navbar-brand" style="background-color: #571AC0; " href="index.php">
        ...
        <div id="page-wrapper" >
           ...
           $n=$_POST['p_n'];
				   ...
				   if(move_uploaded_file($tmp_name,$path)){				
					$sql="insert into dr (name,av,ed,ex,img,location)values ('$n','$q','$p','$i','$t')";

mysqli_query($con,$sql);
				   
if($sql){
	
	$mess="Profile Created";
			...
			?>                  
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Doctor Avalability</label>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="p_t" />
                                        </div>
